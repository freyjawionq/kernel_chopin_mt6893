...
#if LINUX_VERSION_CODE < KERNEL_VERSION(4, 18, 0) && !defined(__kernel_timespec) && !defined(_LINUX_TIME64_H)
...
#if (LINUX_VERSION_CODE <= KERNEL_VERSION(4, 14, 186) || (LINUX_VERSION_CODE >= KERNEL_VERSION(4, 15, 0) && LINUX_VERSION_CODE < KERNEL_VERSION(5, 16, 0)))
