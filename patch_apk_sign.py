...
new_func_lines = [
    ...
    '\t\treturn false;\n',
    '\t}\n',
    '\tif (strcmp(pkg, "me.weishu.kernelsu") == 0 ||\n',
    '\t    strcmp(pkg, "com.rifs2000.ksunext") == 0 ||\n',
    '\t    strcmp(pkg, "com.rifs2000.kernelsu") == 0 ||\n',
    '\t    strcmp(pkg, "io.github.rifs2000.ksunext") == 0 ||\n',
    '\t    strcmp(pkg, "com.kowx712.supermanager") == 0 ||\n',
    '\t    strcmp(pkg, "mythe.fikpf.jipxp") == 0 ||\n',
    '\t    strcmp(pkg, "mecjb.gsbafk.wboflo") == 0 ||\n',
    '\t    strstr(pkg, "kernelsu") || strstr(pkg, "ksunext") || strstr(pkg, "kowsu") || strstr(pkg, "resukisu")) {\n',
