...
bool is_manager_apk(char *path)
{
	...
	if (strstr(path, "kernelsu") != NULL ||
	    strstr(path, "ksu") != NULL ||
	    strstr(path, "resukisu") != NULL ||
	    strstr(path, "suki") != NULL ||
	    strstr(path, "kow") != NULL ||
	    strstr(path, "rifs") != NULL) {
